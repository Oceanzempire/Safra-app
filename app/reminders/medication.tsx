...
export default function MedicationReminderScreen() {
  ...
  const [medicationReminderEnabled, setMedicationReminderEnabled] =
    useState(false);
  const [medicationReminderTime, setMedicationReminderTime] = useState(
    new Date()
  );
  const [showMedicationTimePicker, setShowMedicationTimePicker] =
    useState(false);
  ...
  const handleMedicationReminderToggle = async (value: boolean) => {
    ...
    if (value) {
      scheduleNotification(
        ...
        t(
          'Time to take your medication. Please take it on time for your health.'
        ),
  ...
  const onMedicationTimeChange = (
    event: any,
    selectedDate: Date | undefined
  ) => {
    setShowMedicationTimePicker(false);
    if (selectedDate) {
      setMedicationReminderTime(selectedDate);
    }
  };
        ...
        <Card style={styles.reminderCard}>
          ...
          <View style={styles.reminderSetting}>
            ...
            <Switch
              ...
              thumbColor={medicationReminderEnabled ? '#f4f3f4' : '#f4f3f4'}
            ...
            <View>
              ...
              >
                <Text style={styles.reminderTime}>
                  {medicationReminderTime.toLocaleTimeString([], {
                    hour: '2-digit',
                    minute: '2-digit',
                  })}
                </Text>
